    ...
    <main class="max-w-5xl mx-auto pt-20 px-4 flex justify-center gap-8 pb-14 sm:pb-10">
        <div class="w-full max-w-[470px] flex flex-col gap-6">
            <div class="bg-white border border-gray-200 rounded-sm">
                <div class="flex items-center justify-between p-3">
                    <div class="flex items-center gap-3">
                        <img src="https://ui-avatars.com/api/?name=johndoe&background=random" class="w-8 h-8 rounded-full border border-gray-200">
                        <span class="font-semibold text-sm">johndoe</span>
                        <span class="text-gray-400 text-xs font-normal">• 12h</span>
                    </div>
                </div>
                <img src="https://images.unsplash.com/photo-1516280440502-869f3d9db307?w=800&auto=format&fit=crop" class="w-full object-cover aspect-square bg-gray-100">
                <div class="p-3">
                    ...
                    <div class="font-semibold text-sm mb-1">124 likes</div>
                    <div class="text-sm">
                        <span class="font-semibold">johndoe</span> Great day out with friends!
                    </div>
                    <div class="text-gray-400 text-sm mt-1 mb-2">View all 12 comments</div>
            ...
            <div class="bg-white border border-gray-200 rounded-sm">
                <div class="flex items-center justify-between p-3">
                    <div class="flex items-center gap-3">
                        <img src="https://ui-avatars.com/api/?name=janedoe&background=random" class="w-8 h-8 rounded-full border border-gray-200">
                        <span class="font-semibold text-sm">janedoe</span>
                        <span class="text-gray-400 text-xs font-normal">• 1d</span>
                    </div>
                </div>
                <img src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800&auto=format&fit=crop" class="w-full object-cover aspect-square bg-gray-100">
                <div class="p-3">
                    <div class="flex gap-4 mb-2">
                        <button class="text-black hover:text-gray-500"><svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg></button>
                        <button class="text-black hover:text-gray-500"><svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg></button>
                    </div>
                    <div class="font-semibold text-sm mb-1">89 likes</div>
                    <div class="text-sm">
                        <span class="font-semibold">janedoe</span> Nature walk. 🌲
                    </div>
                    <div class="text-gray-400 text-sm mt-1 mb-2">View all 5 comments</div>
                    <div class="flex items-center gap-2 border-t border-gray-100 pt-2 mt-2">
                        <input type="text" placeholder="Add a comment..." class="w-full text-sm outline-none bg-transparent py-1">
                        <button class="text-blue-500 font-semibold text-sm">Post</button>
                    </div>
